#!/bin/bash
# Test Qwen3-Coder-Next Q4 (80B) on :8080 using Chat Completions API
# Run: ./examples/test_coder_next_q4_chat.sh
# Output: examples/log_coder_next_q4_chat.txt

set -e

cd "$(dirname "$0")/.."

LOG="examples/log_coder_next_q4_chat.txt"
MODEL='/Users/kodep/models/bartowski/qwen3-coder-next-q4/Qwen_Qwen3-Coder-Next-Q4_K_M/Qwen_Qwen3-Coder-Next-Q4_K_M.gguf'
...
echo "Running: Coder-Next Q4 (80B) + Chat Completions on $BASE_URL"
echo "Model: $MODEL"
echo "Prompt: $PROMPT"
echo "Log: $LOG"
echo "========================================"
