#!/bin/bash
# Test Qwen3.6-27B (Q4) on :8080 using Responses API
# Run: ./examples/test_qwen36_27b_responses.sh
# Output: examples/log_qwen36_27b_responses.txt

set -e

cd "$(dirname "$0")/.."

LOG="examples/log_qwen36_27b_responses.txt"
...
echo "Running: Qwen3.6-27B (Q4) + Responses API on $BASE_URL"
echo "Model: $MODEL"
echo "Prompt: $PROMPT"
echo "Log: $LOG"
echo "========================================"
