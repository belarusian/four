#!/bin/bash
# Test Qwen3.6-27B on any endpoint using Chat Completions API with tool calls
# Run: FIVE_BASE_URL=http://192.168.1.XXX:808X/v1 ./examples/test_toolcall.sh
...
echo "Running: Tool Calls on $BASE_URL"
echo "Prompt: $PROMPT"
echo "Log: $LOG"
echo "========================================"
